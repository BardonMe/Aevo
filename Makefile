#############################################################################
# Makefile for building: Aevo-qt
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  Aevo.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile Aevo.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Aevo-qt2.1.0.3
DISTDIR = /root/test/vantaur/build/Aevo-qt2.1.0.3
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 /root/test/vantaur/src/leveldb/libleveldb.a /root/test/vantaur/src/leveldb/libmemenv.a /root/test/vantaur/src/secp256k1/src/libsecp256k1_la-secp256k1.o -lminiupnpc -lssl -lcrypto -ldb_cxx -lgmp -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lQt5PrintSupport -lQt5Widgets -lQt5Gui -lQt5Network -lQt5DBus -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
clean: compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /root/test/vantaur/src/leveldb/libleveldb.a; cd /root/test/vantaur/src/leveldb ; $(MAKE) clean /root/test/vantaur/src/secp256k1/src/libsecp256k1_la-secp256k1.o; cd /root/test/vantaur/src/secp256k1; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/root/test/vantaur/src/leveldb/libleveldb.a: FORCE
	cd /root/test/vantaur/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/root/test/vantaur/src/secp256k1/src/libsecp256k1_la-secp256k1.o: FORCE
	cd /root/test/vantaur/src/secp256k1 && ./autogen.sh && ./configure --enable-module-recovery && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2"

/root/test/vantaur/build/build.h: FORCE
	cd /root/test/vantaur; /bin/sh share/genbuild.sh /root/test/vantaur/build/build.h
...
build/moc_bitcoingui.cpp: src/qt/bitcoingui.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I/root/test/vantaur -I/root/test/vantaur/src -I/root/test/vantaur/src/json -I/root/test/vantaur/src/qt -I/root/test/vantaur/src/qt/plugins/mrichtexteditor -I/root/test/vantaur/src/leveldb/include -I/root/test/vantaur/src/leveldb/helpers -I/root/test/vantaur/src/secp256k1/include -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtPrintSupport -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtNetwork -I/usr/include/x86_64-linux-gnu/qt5/QtDBus -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/5 -I/usr/include/x86_64-linux-gnu/c++/5 -I/usr/include/c++/5/backward -I/usr/lib/gcc/x86_64-linux-gnu/5/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/5/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include src/qt/bitcoingui.h -o build/moc_bitcoingui.cpp
