...
const string strMessageMagic = "Aevo Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight <= 10){
      nSubsidy = 425000 * COIN;
    } else if (nHeight > 10 && nHeight <= 50){
      nSubsidy = 0 * COIN;
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(nBestHeight >= 1500 && nBestHeight <= 25000){
      nSubsidy = 1275 * COIN;
