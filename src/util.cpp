...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Aevo
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Aevo
    // Mac: ~/Library/Application Support/Aevo
    // Unix: ~/.Aevo
#ifdef WIN32
    // Windows
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Aevo.conf"));
